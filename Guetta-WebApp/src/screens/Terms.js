...
The consideration for your acceptance of these Terms is that we are providing you the Grant of Use to use the Website pursuant to Section 2 hereof. You acknowledge and agree that this consideration is adequate and that you have received the consideration.<br/><br/>
<h5 className="center">2. Grant of Use </h5>
...
This grant is terminable by us at will for any reason and at our sole discretion, with or without prior notice. Upon termination, we may, but shall not be obligated to: (i) delete or deactivate your account, (ii) block your e-mail and/or IP addresses or otherwise terminate your use of and ability to use the Website, and/or (iii) remove and/or delete any of your User Submissions (defined below). You agree not to use or attempt to use the Website after said termination. Upon termination, the grant of your right to use the Website shall terminate, but all other portions of these Terms shall survive. You acknowledge that we are not responsible to you or any third party for the termination of your grant of use.<br/><br/>
<h5 className="center">3. Intellectual Property</h5>
...
<h5 className="center">4. User Submissions</h5>
...
<h5 className="center">5. Content on the Website</h5>
...
You acknowledge that we may at our sole discretion refuse to publish, remove, or block access to any Content for any reason, or for no reason at all, with or without notice.<br/><br/>
<h5 className="center">6. User Conduct</h5>
...
We do not store any User Submissions for anything longer than a transitory period of time to give users chance to download their content.<br/><br/>
<h5 className="center">8. Fees</h5>
...
<h5 className="center">9. Privacy Policy</h5>

We retain a separate Privacy Policy and your assent to these Terms also signifies your assent to the Privacy Policy. We reserve the right to amend the Privacy Policy at any time by posting such amendments to the Website. No other notification may be made to you about any amendments. Your continued use of the Website following such amendments will constitute your acceptance of such amendments, regardless of whether you have actually read them.<br/><br/>
<h5 className="center">10. Copyright Claims</h5>
...
A statement that you will accept service of process from the purported copyright owner or its agent.<br/><br/>
<h5 className="center">11. Modification of These Terms</h5>

We reserve the right to amend these Terms at any time by posting such amended Terms to the Website. No other notification may be made to you about any amendments. YOU ACKNOWLEDGE THAT YOUR CONTINUED USE OF THE WEBSITE FOLLOWING SUCH AMENDMENTS WILL CONSTITUTE YOUR ACCEPTANCE OF SUCH AMENDMENTS, REGARDLESS OF WHETHER YOU HAVE ACTUALLY READ THEM.<br/><br/>
<h5 className="center">12. Indemnification and Release</h5>
...
<h5 className="center">13. Disclaimer of Warranties and Limitations of Liabilities</h5>
...
If this agreement is translated and executed in any language other than English and there is any conflict as between the translation and the English version, the English version shall control.<br/><br/><br/><br/><br/><br/><br/><br/><br/></h5>
